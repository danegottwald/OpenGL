...
{
   if( !m_pEventSubscriber )
      m_pEventSubscriber = std::make_unique< Events::EventSubscriber >();

   m_pEventSubscriber->Subscribe< Events::KeyPressedEvent >( [ & ]( const Events::KeyPressedEvent& event ) noexcept
   {
