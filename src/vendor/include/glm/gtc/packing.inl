...
//	}
        ...
        struct compute_half<4, Q> {
            GLM_FUNC_QUALIFIER static vec<4, uint16, Q> pack(vec<4, float, Q> const &v) {
                vec<4, int16, Q> const Unpack(detail::toFloat16(v.x), detail::toFloat16(v.y), detail::toFloat16(v.z),
            ...
            GLM_FUNC_QUALIFIER static vec<4, float, Q> unpack(vec<4, uint16, Q> const &v) {
                i16vec4 Unpack;
                memcpy(&Unpack, &v, sizeof(Unpack));
                return vec<4, float, Q>(detail::toFloat32(v.x), detail::toFloat32(v.y), detail::toFloat32(v.z),
                                        detail::toFloat32(v.w));
            }
        };
    }//namespace detail
    ...
    GLM_FUNC_QUALIFIER vec<4, T, Q> packRGBM(vec<3, T, Q> const &rgb) {
        ...
        T Alpha = clamp(max(max(Color.x, Color.y), max(Color.z, static_cast<T>(1e-6))), static_cast<T>(0),
                        static_cast<T>(1));
    ...
    GLM_FUNC_QUALIFIER vec<L, uintType, Q> packUnorm(vec<L, floatType, Q> const &v) {
        ...
        return vec<L, uintType, Q>(round(clamp(v, static_cast<floatType>(0), static_cast<floatType>(1)) *
    ...
    GLM_FUNC_QUALIFIER vec<L, floatType, Q> unpackUnorm(vec<L, uintType, Q> const &v) {
        ...
        return vec<L, float, Q>(v) *
               (static_cast<floatType>(1) / static_cast<floatType>(std::numeric_limits<uintType>::max()));
    }
    ...
    GLM_FUNC_QUALIFIER vec<L, intType, Q> packSnorm(vec<L, floatType, Q> const &v) {
        ...
        return vec<L, intType, Q>(round(clamp(v, static_cast<floatType>(-1), static_cast<floatType>(1)) *
    ...
    GLM_FUNC_QUALIFIER vec<L, floatType, Q> unpackSnorm(vec<L, intType, Q> const &v) {
        ...
        return clamp(vec<L, floatType, Q>(v) *
                     (static_cast<floatType>(1) / static_cast<floatType>(std::numeric_limits<intType>::max())),
